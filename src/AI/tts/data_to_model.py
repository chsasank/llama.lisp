...
def gcp_tts(line, fname, language_code ="te-IN", voice_name ="te-IN-Chirp3-HD-Achernar", gender = "FEMALE"):
    ...
    voice = texttospeech.VoiceSelectionParams(
        language_code = language_code, name = voice_name ,ssml_gender=texttospeech.SsmlVoiceGender.FEMALE )
...
if __name__ == "__main__":
    ...
    print("Enter the language . For example for kannada it is kn-IN, for Telugu it is te-IN")
    language_code = input()
    ...
    ds = Dataset.from_dict({
        ...
        "description": [f'{speaker} speaks {language_name} in a natural tone'] * len(audio_prompts)
